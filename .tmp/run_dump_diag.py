...
TAG = sys.argv[1] if len(sys.argv) > 1 else "z3_opt"
argv = ([PY, "scripts/mgba_drive.py", "--schedule", SCHED, "--frames", "3100",
         "--tag", TAG, "--dump"]
...
for ln in (r.stdout or "").splitlines():
    if any(k in ln for k in ("IO ", "dump", "final shot", "ERROR", "ABORT", "shot", "launch")):
        print(ln)
