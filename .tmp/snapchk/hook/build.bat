...
echo === Compiling text\diag_log.c ===
...
> %OUT%\game_syms.asm (
    ...
    for %%S in (MapName_DisplayCellLength UnusedPrintMonName_Hook DrawOptionMenuChoice_Hook UpdateNickInHealthbox_Hook UpdateNickInHealthbox_Hook_Other UpdateTilemap_Origin InitTextPrinter_Hook SetWindowTileCache_Hook) do (
