; AXVJ (Pocket Monsters Ruby JP) text-engine addresses
; Located via control-code fingerprint (0xFA..0xFF) and font table xrefs.
...
; --- Width functions ---
GetGlyphWidth                          equ 0x08004B1C  ; guessed from BL target at 0x08004CCC
GetStringWidth                         equ 0x08004CC0  ; guessed from proximity

; --- Font data (extended ROM) ---
GameBinAddresses                       equ 0x08800000
HackFunctionAddresses                  equ GameBinAddresses
FontChsNormal                          equ 0x09000000
FontChsSmall                           equ 0x09100000
; PhraseOffsets / PhraseTable: labels via phrase_data.asm (.org 0x08810000 / 0x08820000)

; --- Writable EWRAM scratch ---
; ChineseTileState: +0 u16 last charBase; +2 u8 write.op (F9 XX); +4 u16 next_abs
...
; --- Battle UI (TODO GDB: Δ=-0x68 from US) ---
