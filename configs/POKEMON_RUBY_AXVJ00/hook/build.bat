...
echo === Compiling text_translater.c (F9 protocol layer) ===
%CC% %CFLAGS% %SRC_ROOT%\text\text_translater.c -o %BUILD%\text_translater.o
if errorlevel 1 exit /b 1
...
echo === Compiling text_layout.c (tm1 layout algorithms) ===
