 ...
 *   3) 文字区总宽 = 10 列 × 8px = 80px（v5/v6 实测反推：left=9 格时未白镇的
 *      「镇」出框、left=7 格时101号道路的「道路」出框，框右缘均 ≈88px；
 *      textMode=3 弹窗每字符步进 8px，与原生「10 字符字段 + left=1」自洽）。
 *
 * 宽度计算已抽至 GetStringWidth.c（GetStringWidth_PCS），本文件只留 MAP 场景
 * 常量与居中换算。
 *
