...
用法：
  python dump_addr_bands.py rom.gba
...
def main() -> None:
    if len(sys.argv) != 2 or sys.argv[1] in ("-h", "--help"):
        print("Usage: python dump_addr_bands.py <rom.gba>", file=sys.stderr)
    ...
    bands_doc = {
        "_meta": {
            ...
            "exported_by": "dump_addr_bands.py",
        },
    ...
    result["_meta"]["exported_by"] = "dump_addr_bands.py"
