#!/usr/bin/env node
/**
 * 独立识图脚本 — 调用 OpenAI 兼容的 vision 模型，按量付费。
 *
 * 用法:
...
// 无 dotenv 依赖时的内置 .env 解析（只覆盖尚未设置的环境变量）
...
const API_KEY = process.env.VISION_API_KEY || "sk-xxx";
const MODEL = process.env.VISION_MODEL || "qwen-audio-3.0-realtime-flash";
